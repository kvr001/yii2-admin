 ...
 * 'controllerMap' => [
 *     'assignment' => [
 *         'class' => 'kvr001\admin\controllers\AssignmentController',
...
class Module extends \yii\base\Module
{
     ...
     * Its used when `layout` set to 'left-menu', 'right-menu' or 'top-menu'.
     */
    public $mainLayout = '@kvr001/admin/views/layouts/main.php';
    /**
     * @var array
     * @see [[menus]]
     */
    ...
    public function init()
    {
        ...
        if (class_exists('yii\jui\JuiAsset')) {
            Yii::$container->set('kvr001\admin\AutocompleteAsset', 'yii\jui\JuiAsset');
        }
    }
